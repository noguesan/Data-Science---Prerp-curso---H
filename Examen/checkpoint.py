        ...
        for elemento_l1 in lista:
                if (type(elemento_l1)== list):
                    for elemento_l2 in elemento_l1:
                        if (type(elemento_l2)== list):
                                for elemento_l3 in elemento_l2:
                                    if (type(elemento_l3)== list):
                                       for elemento_l4 in elemento_l3:
                                            lista_separada.append(elemento_l4)
                                    else:
                                        lista_separada.append(elemento_l3)
                        else:
